...
import com.laioin.services.common.utils.JsonUtil;
import com.laioin.services.common.utils.Tools;
 ...
 * 自己处理，请求
 */
public class BootDispatcherServlet extends DispatcherServlet {

    private Logger LGR = LoggerFactory.getLogger(BootDispatcherServlet.class);

    public BootDispatcherServlet(AnnotationConfigWebApplicationContext applicationContext) {
    ...
    protected void doService(HttpServletRequest request, HttpServletResponse response) throws Exception {
       ...
       /*
        ...
        BootRequestWrapper meRequest = new BootRequestWrapper(request, out);
